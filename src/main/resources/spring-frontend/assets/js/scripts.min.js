        ...
        var Card = function () {
            var bookTemplate = function (book) {
                return '<div class="Card">' + '   <div class="Card-picture">' + '<a href="' + book.slug + '">' + '       <img src="' + book.image + '">\n' + '</a>' +
                    ...
                    (book.discountPrice ? '<span class="Card-priceOld">BYN' + book.price + '</span>\n' : '') + '                       <span class="Card-price">BYN' + book.discountPrice + '</span>\n' + '                </div>\n' + '              </div>\n' + '            </div>';
            }
            return {
                init: function () {
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'mainRecent':
                                                sendData('/books/mainRecent')
                                                break;
                                            case'mainPopular':
                                                sendData('/books/mainPopular')
                                                break;
                                        }
                                    }
                                }
